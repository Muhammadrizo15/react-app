            ...
            <div className="fixed-content">
                <div className="left-content">
                    ...
                    <ul className="ul-wrap">
                        ...
                        <li className={location.pathname.includes("/applications") ? "active" : ""}><img src="../img/img-list.png" alt=""/><Link to='/applications'> Мои заявки</Link></li>
                        <li className={location.pathname.includes("/pick-master") ? "active" : ""}><img src="../img/img-white-star.png" alt=""/><Link to="/pick-master"> Мои отзывы</Link></li>
                        <li className={location.pathname.includes("/orders") ? "active" : ""}><img src="../img/img-list-2.png " alt=""/><Link to="/orders"> Мои заказы</Link></li>
                    </ul>
