...
function App() {
    ...
    return (
        <section className="page_4">
            <div className="rew-mas">
                <div className="reviews-master">
                    <div className="rew">
                        <div className="reviews-text font_abel">
                            <h2 className="abel">Отзывы о мастере</h2>
                        </div>
                        <div className="big_text-mast df align font_robo">
                        ...
                        <div className="mas font_robo">
                            <h3 className="roboto">на основании 1 оценки</h3>
                        </div>
                    </div>
                    <div className="rating df align">
                        <div className="grade-level">
                            ...
                            <div className="level_master-2 df align">
                                ...
                                <div className="level_text-2 font_robo">
                                    <p>0</p>
                                </div>
                            </div>
                        ...
                        <div className="rating_info font_robo">
                    ...
                    <div className="reting_info-text font_abel">
                        <input type="text" className="review__input" placeholder="В тексте не должно быть оскорблений и мата"/>
                    </div>

                    <div className="reting_info-button font_abel">
