            ...
            <div className="menu__content" onClick={e => e.stopPropagation()}>
                <div className="left-contedsafsant">
                    ...
                    <ul className="ul-wdsafsdafasdrap">
                        ...
                        <li className={location.pathname.includes("/applications") ? "active imawe" : " imawe"}><img src="../img/img-list.png" alt=""/><Link to='/applications'> Мои заявки</Link></li>
                    ...
                    <div className="iconfsdafsda imawe df">
