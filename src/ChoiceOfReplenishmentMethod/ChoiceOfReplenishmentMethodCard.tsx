    ...
    return (
        <>
            ...
            <div className="mini-cards">
                <div onClick={Active} className="mini-card df border" id="card">
                    <img src="img/img-box.png" alt=""/>
                    <h2>Банковская карта </h2>
                </div>

                <div onClick={Active}  className="mini-card df" id="card-2">
                    <img src="img/img-card.png" alt=""/>
                    <h2>Сбербанк онлайн</h2>
                </div>

                <div onClick={Active}  className="mini-card df" id="card-3">
